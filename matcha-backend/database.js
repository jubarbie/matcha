...
create_database += 'CREATE TABLE matcha_db.user (id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY, fname VARCHAR(255) NOT NULL, lname VARCHAR(255) NOT NULL, email VARCHAR(255), gender VARCHAR(1),  interested_in VARCHAR(1), bio TEXT ) ;';
